...
$$C_V = \frac{\partial Q}{\partial T}\bigg\vert_V$$
similarly, for constant pressure,
$$C_P = \frac{\partial Q}{\partial T}\bigg\vert_P.$$
...
For $E^1$ at equilibrium we will write $E^1_eq$ (sim. for $E^2$). Then to maximise $S$ we must have
